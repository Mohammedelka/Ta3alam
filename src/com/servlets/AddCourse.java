...
public class AddCourse extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		CourseBean bean = new CourseBean(0, course_name, InstructorUserName, course_image, course_description,
		...
		if (i > 0) {
			out.println("<style>\r\n" + ".alert {\r\n" + "	position: absolute !important;\r\n" + "	top: 40;\r\n"
					...
					+ "  <p>Aww yeah, you successfully saved your new Course .</p>\r\n" + "  <hr>\r\n"
					+ "  <p class=\"mb-0\">Now,You can go to Course list to Edit your content.</p>\r\n" + "</div>");
		}
