...
public class AddInstructor  extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Add Instructor </title>");
		out.println("</head>");
		out.println("<body>");
		...
		InstructorBean bean=new InstructorBean(name, email, password, smobile);
		InstructorDao.save(bean);
		out.print("<h4>Instructor  added successfully</h4>");
