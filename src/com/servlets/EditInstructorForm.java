...
@WebServlet("/EditInstructorForm")
public class EditInstructorForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Edit Instructor Form</title>");
		out.println("</head>");
		out.println("<body>");
		...
		InstructorBean bean=InstructorDao.viewById(id);
		
		out.print("<form action='EditInstructor' method='post' style='width:300px'>");
